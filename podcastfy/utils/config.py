...
class Config:
	...
	def configure(self, **kwargs):
		...
		for key, value in kwargs.items():
			...
			elif key in ['JINA_API_KEY', 'GEMINI_API_KEY', 'OPENAI_API_KEY', 'ELEVENLABS_API_KEY', 'AZURE_SPEECH_KEY']:
...
def main() -> None:
	...
	print(f"AZURE_SPEECH_KEY: {'Set' if config.AZURE_SPEECH_KEY else 'Not set'}")

	# Print a warning for any missing configuration
	missing_config = []
	for key in ['JINA_API_KEY', 'GEMINI_API_KEY', 'OPENAI_API_KEY', 'ELEVENLABS_API_KEY', 'AZURE_SPEECH_KEY']:
